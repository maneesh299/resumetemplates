  ...
  \cventry
    ...
    {Oct. 2023 - Present} % Date(s)
    {
      \begin{cvitems} % Description(s) of tasks/responsibilities        
        \item {Monitored and scheduled SAP BODS ETL jobs via the Data Services Management Console, ensuring timely and reliable data ingestion.}
        \item {Managed access provisioning and user roles within the Central Management Repository to maintain secure and organized development workflows.}
        \item {Handled repository configuration and job execution logging to support auditability and operational transparency across ETL pipelines.}
