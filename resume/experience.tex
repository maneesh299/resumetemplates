  ...
  \cventry
    ...
    {Oct. 2023 - Present} % Date(s)
    {
      \begin{cvitems} % Description(s) of tasks/responsibilities 
        \item {Developed and trained machine‑learning models on Google Vertex AI using feature‑engineered datasets stored in AWS Storage, implementing a scalable MLOps workflow from data preparation through model evaluation.}       
        \item {Led a team of Data Engineering to design and implement end to end datapipeline using dbt and containerized applications deployed on EKS, orchestrated with Airflow and integrated with CI/CD pipelines for automated testing and deployment.}       
        ...
        \item {Orchestrated recurring batch‑training pipelines in AWS Step Functions and Amazon MWAA, automating data ingestion from Amazon S3 and retraining Amazon SageMaker models on a scheduled cadence to ensure model freshness and sustained predictive performance.}
