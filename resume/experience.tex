...
%---------------------------------------------------------
  \cventry
    {Senior QAOps Engineer} % Job title
    {Dyson UK.} % Organization
    {Bristol, UK} % Location
    {Oct. 2023 - Present} % Date(s)
    {
      \begin{cvitems} % Description(s) of tasks/responsibilities 
        \item {Designed and implemented automated end‑to‑end UI test suites using WebdriverIO, improving regression coverage and ensuring consistent quality across core e‑commerce user journeys.}       
